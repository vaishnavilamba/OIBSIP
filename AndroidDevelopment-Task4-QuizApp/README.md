...
A simple Android Quiz Application developed using Kotlin and XML. The app allows users to answer multiple-choice questions, calculates the score, and displays the final result.
